# 🟢 Supabase & pgvector Developer Studio

> Deploy local Supabase databases with native pgvector vector extensions, Row-Level Security (RLS) policies, and seed data templates. Generate postgres SQL schemas, seed files, and CLI configs.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/supabase-pgvector/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chatbot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-supabase-pgvector.git
cd tp-supabase-pgvector
```
...
```bash
kubectl port-forward deployment/tp-supabase-pgvector 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── supabase_schema.sql     # Main configuration file
```
...
---
*Generated by [Supabase & pgvector Developer Studio Studio](https://pradeeptalari14.github.io/portfolio/tools/supabase-pgvector/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
